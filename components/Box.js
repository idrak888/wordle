		...
		<View style={(props.isActive || char !== "") ? !props.color ? styles.active : {...styles.active, backgroundColor: props.color, borderColor: props.color} : styles.box}>
			{
				...
				}} autoFocus={true} onChangeText={char => handleChange(char)} value={char} keyboardAppearance='dark' autoCapitalize="characters" returnKeyType="next" maxLength={2} style={styles.input}/>
				: char !== "" ?
